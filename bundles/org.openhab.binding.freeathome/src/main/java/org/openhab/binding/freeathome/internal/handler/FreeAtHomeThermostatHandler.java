...
public class FreeAtHomeThermostatHandler extends FreeAtHomeBaseHandler {
    ...
    private FreeAtHomeThermostatConfig mConfiguration = new FreeAtHomeThermostatConfig();
    ...
    @Override
    public void setUp() {
        mConfiguration = getConfigAs(FreeAtHomeThermostatConfig.class);
        ...
        if (bridge != null) {
            ...
            mUpdateChannels.add(
                    new FreeAtHomeUpdateChannel(this, FreeAtHomeBindingConstants.THERMOSTAT_TARGET_TEMP_THING_CHANNEL,
                            new TargetTempDecimalTypeConverter(), mConfiguration.deviceId, mConfiguration.channelId,
                            mConfiguration.dataPointIdTargetUpdate));
            ...
            mUpdateChannels.add(new FreeAtHomeUpdateChannel(this,
                    ...
                    mConfiguration.deviceId, mConfiguration.channelId, mConfiguration.dataPointIdEcoUpdate));
